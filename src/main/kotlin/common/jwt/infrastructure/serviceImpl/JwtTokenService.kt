...
import com.peekr.common.jwt.domain.entity.JwtTokenPayload
...
class JwtTokenService(
    ...
    private val audience by lazy {
        appConfig.applicationConfiguration.propertyOrNull("jwt.audience")?.getString()
            ?: "jwt-audience"
    }

    private val realm by lazy {
        appConfig.applicationConfiguration.propertyOrNull("jwt.realm")?.getString()
            ?: "jwt-realm"
    }

    private val issuer by lazy {
        appConfig.applicationConfiguration.propertyOrNull("jwt.issuer")?.getString()
            ?: "jwt-issuer"
    }
    ...
    private val secretKey by lazy {
        appConfig.applicationConfiguration.propertyOrNull("jwt.secret")?.getString()
            ?: "jwt-secret"
    }
    ...
    fun generate(payload: JwtTokenPayload): JwtToken {
        val accessToken = JWT
            ...
            .withClaim(payload.claimName, payload.claim)
